...
const i18n = {
  ru: {
    ...
    exp1_desc: "Проектирование мультипровайдерной AI-архитектуры, FSM-конфигураторы, RAG-пайплайны, рефакторинг Python, REST API на Go, multi-stage Docker, архитектурная документация.",
    exp2_role: "Techcoredev.ru · Системный аналитик",
    exp2_desc: "Система управления страховыми продуктами. Полный цикл спецификаций, BPMN/ERD/UML/C4, реверс-инжиниринг legacy с AI.",
    exp3_role: "Raccoonsoft & Devexperts · Ведущий аналитик",
    exp3_desc: "Мобильная платформа Tastyworks iPad (tastytrade.com) — торговля акциями, деривативами, форекс и криптовалютами.",
    exp4_role: "ЛАНИТ-ТЕРКОМ · Ведущий аналитик",
    exp4_desc: "ЖКХ ВЦКП-ЕИРЦ, МЭШ ДИТ Москвы, Газпром нефть, ЕМИАС, Toyota, AREA9 и другие крупные проекты.",
    exp5_role: "Devexperts.com · Бизнес/системный/финансовый аналитик",
    exp5_desc: "ThinkOrSwim, GFT Dealbook 360, DXtrade — торговые платформы, FIX-интеграции, риск-менеджмент, бэк-офис.",
  ...
  en: {
    ...
    exp1_desc: "Multi-provider AI architecture design, FSM configurators, RAG pipelines, Python refactoring, Go REST API, multi-stage Docker, architectural documentation.",
    exp2_role: "Techcoredev.ru · Systems Analyst",
    exp2_desc: "Insurance product management system. Full specification lifecycle, BPMN/ERD/UML/C4, AI-assisted legacy reverse engineering.",
    exp3_role: "Raccoonsoft & Devexperts · Lead Analyst",
    exp3_desc: "Tastyworks iPad mobile trading platform (tastytrade.com) — stocks, derivatives, FX, and crypto trading.",
    exp4_role: "LANIT-TERCOM · Lead Analyst",
    exp4_desc: "Housing utilities VCKP-EIRC, Moscow Electronic School, Gazprom Neft, EMIAS, Toyota, AREA9 and other large-scale projects.",
    exp5_role: "Devexperts.com · Business / Systems / Financial Analyst",
    exp5_desc: "ThinkOrSwim, GFT Dealbook 360, DXtrade — trading platforms, FIX integrations, risk management, back office.",
