"""
Standalone CV PDF generator — no Flask app context required.
Uses Jinja2 directly to render the template and WeasyPrint to produce PDF.
"""
import json
import os
...
CV_DATA = {
    "ru": {
        ...
        "skills": [
            {"category": "Языки",        "stack": "Python 3.10+, Go 1.22, SQL, Java, Bash, MQL, TeX"},
            {"category": "AI / LLM",     "stack": "OpenAI API, Claude, Gemini, DeepSeek, GLM, Llama, Qwen; function calling, MCP, RAG, LangChain, ChromaDB"},
            {"category": "Фреймворки",   "stack": "FastAPI, Flask, aiogram 3, Pydantic, Jinja2, WeasyPrint, aiohttp"},
            {"category": "Данные",       "stack": "PostgreSQL, SQLite, Oracle, MS SQL Server, 1С, pandas, openpyxl, yfinance"},
            {"category": "ML",           "stack": "scikit-learn, LightGBM, PyTorch Lightning, LSTM, TFT, optuna, shap"},
            {"category": "Инфраструктура","stack": "Docker, Docker Compose, Grafana Loki, GitHub Actions"},
            {"category": "BA/SA",        "stack": "Confluence, JIRA, BPMN, UML, C4, PlantUML, Draw.io, Figma, ARIS, Bizagi, Enterprise Architect"},
            {"category": "Стандарты",    "stack": "PMBoK, BABOK, ГОСТ 34, IEEE 830, ISO/IEC/IEEE 29148"},
        ],
        "education": [
            {"degree": "К.ф.-м.н., Математическая кибернетика", "years": "1995–1998",
             "place": "СПбГУ, аспирантура, факультет прикладной математики и процессов управления"},
            {"degree": "Математик, Прикладная математика", "years": "1990–1995",
             "place": "СПбГУ, факультет прикладной математики и процессов управления"},
            {"degree": "Экономист, Финансы и кредит", "years": "1999–2002",
             "place": "СПбГУ (экономический факультет) и Международный банковский институт (МБИ)"},
        ],
    },
    "en": {
        ...
        "skills": [
            {"category": "Languages",      "stack": "Python 3.10+, Go 1.22, SQL, Java, Bash, MQL, TeX"},
            {"category": "AI / LLM",       "stack": "OpenAI API, Claude, Gemini, DeepSeek, GLM, Llama, Qwen; function calling, MCP, RAG, LangChain, ChromaDB"},
            {"category": "Frameworks",     "stack": "FastAPI, Flask, aiogram 3, Pydantic, Jinja2, WeasyPrint, aiohttp"},
            {"category": "Data",           "stack": "PostgreSQL, SQLite, Oracle, MS SQL Server, 1C, pandas, openpyxl, yfinance"},
            {"category": "ML",             "stack": "scikit-learn, LightGBM, PyTorch Lightning, LSTM, TFT, optuna, shap"},
            {"category": "Infrastructure", "stack": "Docker, Docker Compose, Grafana Loki, GitHub Actions"},
            {"category": "BA/SA",          "stack": "Confluence, JIRA, BPMN, UML, C4, PlantUML, Draw.io, Figma, ARIS, Bizagi, Enterprise Architect"},
            {"category": "Standards",      "stack": "PMBoK, BABOK, GOST 34, IEEE 830, ISO/IEC/IEEE 29148"},
        ],
        "education": [
            {"degree": "PhD in Mathematics (Mathematical Cybernetics)", "years": "1995–1998",
             "place": "Saint Petersburg State University, Postgraduate, Faculty of Applied Mathematics"},
            {"degree": "MSc, Applied Mathematics", "years": "1990–1995",
             "place": "Saint Petersburg State University, Faculty of Applied Mathematics"},
            {"degree": "Economist, Finance and Credit", "years": "1999–2002",
             "place": "Saint Petersburg State University (Economics Faculty) & International Banking Institute (IBI)"},
        ],
    },
}
...
def build_cv_pdf(lang: str) -> bytes:
    """Generate CV PDF bytes from data. Works without Flask app context."""
    ...
    template = _jinja_env.get_template("cv_pdf.html")
